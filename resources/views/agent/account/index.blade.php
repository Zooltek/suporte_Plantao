...
@section('content')
<div class="max-w-2xl mx-auto space-y-6" x-data="{ loading: false }">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <form action="{{ route('agent.account.update') }}" method="POST" autocomplete="off" @submit="loading = true">
            @csrf
            @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}"
                                       class="block w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none transition-all">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="password" name="old_password" id="old_password" placeholder="••••••••"
                                   class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none transition-all">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-gray-100">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">Intervalo em segundos para busca de novos chamados.</p>
                            </div>
                            <div class="flex items-center gap-2 ml-4 flex-shrink-0">
                                <input type="number" name="refresh_rate" id="refresh_rate" value="{{ $user->refresh_rate }}" min="5"
                                       class="w-20 px-3 py-2 text-center font-mono font-bold text-sm bg-white border border-gray-300 text-orange-600 rounded-lg focus:ring-2 focus:ring-orange-500/50 focus:border-orange-500 outline-none">
                        ...
                        <div class="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-gray-100">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">Exibe a árvore de categorias na lista de chamados.</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer ml-4 flex-shrink-0">
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end">
                <button type="submit" :disabled="loading"
                        class="inline-flex items-center gap-2 px-8 py-2.5 bg-orange-600 hover:bg-orange-700 text-white text-sm font-semibold rounded-xl shadow-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed">
